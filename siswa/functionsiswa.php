...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$nis','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$agama','$no_hp','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', agama = '$agama',no_hp = $no_hp, email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nis = $nis";
