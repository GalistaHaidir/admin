...
function tambah($data)
{
    ...
    $sql = "INSERT INTO guru VALUES ('$nip','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$agama','$no_hp','$email','$gambar','$alamat','$status')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE guru SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', agama = '$agama',no_hp = $no_hp, email = '$email', gambar = '$gambar', alamat = '$alamat', status = '$status' WHERE nip = $nip";
