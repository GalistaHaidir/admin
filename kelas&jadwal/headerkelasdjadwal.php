...
// Menampilkan semua data dari table kelasdjadwal berdasarkan nis secara Descending
$kelasdjadwal = query("SELECT * FROM kelasdjadwal ORDER BY kelas DESC");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="datakelasdjadwal.php">Data Jadwal</a></li>
