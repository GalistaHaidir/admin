...
if (isset($_POST['simpan'])) {
    if (tambah($_POST) > 0) {
        echo "<script>
                alert('Data kelasdjadwal berhasil ditambahkan!');
                document.location.href = 'datakelasdjadwal.php';
            </script>";
    } else {
        // Jika fungsi tambah dari 0/data tidak tersimpan, maka munculkan alert dibawah
        echo "<script>
                alert('Data kelasdjadwal gagal ditambahkan!');
            </script>";
    }
}
...
<div class="container">
    <div class="row my-2">
        <div class="col-md">
            <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Jadwal
            </h3>
        </div>
        <hr>
    </div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-md w-50" id="id"
                        placeholder="Masukkan ID kelas&jadwal" name="id" autocomplete="off" required>
                </div>
                <div class="mb-3">
                    <label>Kelas</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-md w-50" id="mapel"
                        placeholder="Masukkan Nama Mata Pelajaran" name="mapel" autocomplete="off" required>
                </div>
                <div class="mb-3">
                    <label>Hari</label>
                    <div class="form-check">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control w-50" id="tgl_uts" name="tgl_uts" max="01-01-2005" required>
                </div>
                <div class="mb-3">
                    <label for="tgl_uas" class="form-label">Tanggal UAS</label>
                    <input type="date" class="form-control w-50" id="tgl_uas" name="tgl_uas" max="01-01-2006" required>
                </div>
                <hr>
